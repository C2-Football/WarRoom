(function () {
    ...
    function CommunityPanel({ onOpenOnline, onProfile }) {
        ...
        return h('section',{className:'tl-community'},
            ...
            !userId ? h('div',{className:'tl-card'},h('h2',null,'Join the community'),h('p',null,'Sign in to find players and manage invitations. You choose whether your profile appears publicly.'),h('a',{className:'tl-btn primary',href:'login.html?vault=1'},'Sign in')) : h(React.Fragment,null,
