(function () {
    ...
    function WeekGates({ league, onlineMeta, saving, dataReady, onAction, onNavigate }) {
        ...
        return h('section', { className: 'tl-stage-gates tl-card', 'aria-label': 'Weekly stages' },
            ...
            h('div', { className: 'tl-stage-actions' },
                h('button', { className: 'tl-btn', onClick: () => onNavigate(stage.tab) }, stage.tab === 'home' ? 'Read weekly recap' : stage.tab === 'gameday' ? 'Open game day' : stage.tab === 'roster' ? 'Review roster' : 'Open waiver bids'),
