...
(function() {
    ...
    const CSS = `
        ...
        .pick-brief-timing{border:1px solid var(--brief-line);padding:10px 13px;border-radius:var(--card-radius-sm, 8px);flex-shrink:0;text-align:right;min-width:94px}.pick-brief-timing strong{display:block;color:var(--gold);font:700 1.35rem var(--font-display,Rajdhani,sans-serif)}.pick-brief-timing span{display:block;color:var(--silver);font-size:.61rem;margin-top:2px}
        .pick-brief-build{display:flex;gap:6px;flex-wrap:wrap;margin:12px 0 15px}.pick-brief-build>span{display:flex;align-items:center;gap:7px;border:1px solid var(--brief-line);border-radius:var(--card-radius-sm, 8px);padding:6px 8px;font-size:.69rem;background:var(--ov-2,rgba(255,255,255,.025))}.pick-brief-build b{color:var(--pos)}.pick-brief-build small{color:var(--silver);font-size:.6rem}.pick-brief-build .is-needed{border-color:color-mix(in srgb,var(--pos) 48%,transparent);background:color-mix(in srgb,var(--pos) 6%,transparent)}
        .pick-brief-grid{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(0,.85fr);gap:12px}.pick-brief-choice{border:1px solid color-mix(in srgb,var(--gold) 42%,transparent);border-radius:var(--card-radius, 10px);background:linear-gradient(130deg,color-mix(in srgb,var(--gold) 11%,transparent),var(--ov-1,rgba(255,255,255,.01)) 75%);padding:15px;min-width:0;position:relative;overflow:hidden}
        ...
        .pick-brief-alts{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;margin-top:10px}.pick-brief-alt{min-height:76px;border:1px solid var(--brief-line);border-radius:var(--card-radius-sm, 8px);padding:10px;color:var(--white);background:var(--ov-1,rgba(255,255,255,.02));text-align:left;min-width:0}.pick-brief-alt>span{display:block;font-size:.59rem;text-transform:uppercase;font-weight:800;letter-spacing:.07em;color:var(--pos)}.pick-brief-alt strong{display:block;overflow-wrap:anywhere;font-size:.79rem;margin:4px 0}.pick-brief-alt small{font-size:.66rem;color:var(--silver);line-height:1.4;display:block}
        .pick-brief-pressure{border:1px solid var(--brief-line);border-radius:var(--card-radius, 10px);padding:14px;background:var(--ov-1,rgba(255,255,255,.02));min-width:0}.pick-brief-pressure h3{font:700 1.15rem var(--font-display,Rajdhani,sans-serif);margin:4px 0 3px}.pick-brief-pressure p{font-size:.72rem;line-height:1.5;margin:7px 0;color:var(--silver)}.pick-brief-position-tabs{display:flex;gap:4px;flex-wrap:wrap;margin:10px 0}.pick-brief-position-tabs button{min-height:36px;min-width:42px;border:1px solid var(--brief-line);border-radius:var(--card-radius-xs, 5px);background:transparent;color:var(--silver);font-size:.7rem;font-weight:700;padding:5px 9px}.pick-brief-position-tabs button[aria-pressed=true]{color:var(--pos);border-color:var(--pos);background:color-mix(in srgb,var(--pos) 7%,transparent)}
        .pick-brief-runway{display:grid;gap:10px;margin:12px 0}.pick-brief-runway-row>div:first-child{display:flex;gap:8px;align-items:baseline;justify-content:space-between;font-size:.69rem}.pick-brief-runway-row strong{font-size:.76rem;overflow-wrap:anywhere;text-align:right}.pick-brief-runway-row small{color:var(--silver);display:block;font-size:.65rem;margin-top:4px}.pick-brief-bar{height:5px;border-radius:var(--card-radius-sm, 8px);background:var(--ov-5,rgba(255,255,255,.08));overflow:hidden;margin-top:6px}.pick-brief-bar>i{height:100%;display:block;background:var(--pos);border-radius:var(--card-radius-sm, 8px)}.pick-brief-runway-row.is-next .pick-brief-bar>i{opacity:.5}
        ...
        .pick-brief-empty{padding:20px;border:1px dashed var(--brief-line);border-radius:var(--card-radius, 10px);color:var(--silver);font-size:.78rem;line-height:1.6}.pick-brief-set{display:flex;align-items:flex-start;gap:8px;padding:10px 12px;background:rgba(97,215,180,.045);border:1px solid rgba(97,215,180,.16);border-radius:var(--card-radius-sm, 8px);margin-top:12px;font-size:.73rem;color:var(--silver);line-height:1.5}.pick-brief-set strong{color:var(--good,#61d7b4)}
