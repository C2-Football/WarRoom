...
(function() {
    ...
    function LiveRosterBuildCard({ state, grade }) {
        ...
        if (!team) return null;
        return <section className="pick-roster" aria-label="Your actual roster build"><BriefStyles />
