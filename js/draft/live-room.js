...
(function() {
    ...
    const CSS = `
        ...
        .live-room-tabs button,.live-room-control{min-height:44px;padding:8px 12px;border:1px solid var(--ov-6,rgba(255,255,255,.12));border-radius:var(--card-radius-sm, 8px);background:var(--surf-solid,#10161e);color:var(--silver);font-size:.76rem;font-weight:700}
        ...
        .live-room-pulse{display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;padding:11px 14px;margin-bottom:12px;background:var(--ov-2,rgba(255,255,255,.025));border:1px solid var(--acc-line1,rgba(212,175,55,.2));border-radius:var(--card-radius, 10px);color:var(--silver);font-size:.76rem;line-height:1.5}
        ...
        .live-room-pulse button{min-height:44px;padding:8px 12px;border:1px solid var(--acc-line2,rgba(212,175,55,.35));border-radius:var(--card-radius-sm, 8px);background:transparent;color:var(--gold);font:700 .75rem var(--font-body,'DM Sans',sans-serif);cursor:pointer}
        .live-room{color:var(--white);background:var(--surf-solid,#10161e);border:1px solid var(--acc-line1,rgba(212,175,55,.2));border-radius:var(--card-radius-lg, 14px);font-family:var(--font-body,'DM Sans',sans-serif);min-width:0;min-height:0;display:flex;flex-direction:column;overflow:hidden}
        ...
        .live-room-team{width:100%;text-align:left;color:var(--white);background:var(--ov-2,rgba(255,255,255,.025));border:1px solid var(--ov-5,rgba(255,255,255,.08));border-radius:var(--card-radius, 10px);padding:12px;min-width:0;transition:border-color .15s,background .15s}
        ...
        .live-room-positions{display:flex;gap:5px;flex-wrap:wrap;margin:10px 0 8px}.live-room-position{color:var(--pos);font-size:.7rem;border:1px solid color-mix(in srgb,var(--pos) 30%,transparent);border-radius:var(--card-radius-xs, 5px);padding:3px 6px;background:color-mix(in srgb,var(--pos) 7%,transparent);white-space:nowrap}
        ...
        .live-room-metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(105px,1fr));gap:7px;margin:12px 0}.live-room-metric{border:1px solid var(--ov-5,rgba(255,255,255,.08));border-radius:var(--card-radius-sm, 8px);padding:10px}.live-room-metric small{display:block;font-size:.62rem;color:var(--silver);text-transform:uppercase;letter-spacing:.04em}.live-room-metric strong{display:block;font:700 1.18rem var(--font-display,Rajdhani,sans-serif);margin:4px 0}.live-room-metric span{font-size:.68rem;color:var(--silver)}
        .live-room-needs{padding:12px;background:var(--ov-2,rgba(255,255,255,.025));border-radius:var(--card-radius-sm, 8px);margin:12px 0}.live-room-needs p{margin:5px 0;font-size:.74rem;color:var(--silver);line-height:1.5}.live-room-needs strong{color:var(--gold)}
