                        ...
                        return (
                            <button key={key} type="button" aria-expanded={open}
                                ...
                                <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px', minWidth: 0 }}>
                                    ...
                                    <span aria-hidden="true" style={{ color: 'var(--text-muted, #55555f)', fontSize: 'var(--text-label, 0.75rem)', flexShrink: 0, transform: open ? 'rotate(90deg)' : 'none', transition: 'transform 0.12s' }}>›</span>
                                </div>
