            ...
            return React.createElement('div', {
                ...
                React.createElement('div', { style: { flex: 1, minWidth: 0 } },
                    React.createElement('div', { style: { fontSize: 'var(--text-label, 0.75rem)', fontWeight: 600, color: highlight ? 'var(--gold)' : 'var(--white)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' } },
                        event.title,
                        highlight && React.createElement('span', { style: { fontSize: 'var(--text-label, 0.75rem)', fontWeight: 700, padding: '1px 5px', borderRadius: 'var(--card-radius-xs, 5px)', background: 'var(--gold)', color: 'var(--black)', marginLeft: '6px', verticalAlign: 'middle', letterSpacing: '0.04em' } }, 'NEXT'),
                    ),
