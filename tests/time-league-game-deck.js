...
const makeLeague = (seed = 'full-pool') => E.createTimeLeague({ name: 'Game deck', seed, createdAt: '2026-09-08T00:00:00Z', seats: [{ name: 'Home', manager: 'human' }, { name: 'Away', manager: 'ai' }], settings: { hiddenYears: false, regularSeasonWeeks: 12, playoffTeams: 4, maxQuarterbacks: 3, rosterSlots: { QB: 1, BN: 2 }, scoring, eraRules: { mode: 'any-era', decades: [] }, gameDeckVersion: 1 } });
